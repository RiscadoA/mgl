...
extern "C" {
	...
	static inline mgl_f32_t mgl_f32_abs(mgl_f32_t x)
	{
		return fabsf(x);
	}
	...
	static inline mgl_bool_t mgl_f32_equal_e(mgl_f32_t x, mgl_f32_t y, mgl_f32_t epsilon)
	{
		mgl_f32_t dif = y - x;
	...
	static inline mgl_bool_t mgl_f32_nequal_e(mgl_f32_t x, mgl_f32_t y, mgl_f32_t epsilon)
	{
		mgl_f32_t dif = y - x;
		return dif < -epsilon || dif > epsilon;
	}
	...
	static inline mgl_f32_t mgl_f32_deg_to_rad(mgl_f32_t degrees)
	{
	...
	static inline mgl_f32_t mgl_f32_rad_to_deg(mgl_f32_t radians)
	{
	...
	static inline mgl_f32_t mgl_f32_cos(mgl_f32_t angle)
	{
		return cosf(angle);
	}
	...
	static inline mgl_f32_t mgl_f32_sin(mgl_f32_t angle)
	{
		return sinf(angle);
	}
	...
	static inline mgl_f32_t mgl_f32_tan(mgl_f32_t angle)
	{
		return tanf(angle);
	}
	...
	static inline mgl_f32_t mgl_f32_acos(mgl_f32_t angle)
	{
		return acosf(angle);
	}
	...
	static inline mgl_f32_t mgl_f32_asin(mgl_f32_t angle)
	{
		return asinf(angle);
	}
	...
	static inline mgl_f32_t mgl_f32_atan(mgl_f32_t angle)
	{
		return atanf(angle);
	}
	...
	static inline mgl_f32_t mgl_f32_pow(mgl_f32_t x, mgl_f32_t y)
	{
		return powf(x, y);
	}
	...
	/// <param name="x">Value</param>
	/// <returns>Value square</returns>
	static inline mgl_f32_t mgl_f32_square(mgl_f32_t x)
	{
		return x * x;
	}
	...
	static inline mgl_f32_t mgl_f32_sqrt(mgl_f32_t x)
	{
		return sqrtf(x);
	}
	...
	static inline mgl_f32_t mgl_f32_distance_1d(mgl_f32_t x0, mgl_f32_t x1)
	{
	...
	/// <returns>Distance squared</returns>
	static inline mgl_f32_t mgl_f32_distance_2d(mgl_f32_t x0, mgl_f32_t y0, mgl_f32_t x1, mgl_f32_t y1)
	{
	...
	/// <returns>Distance squared</returns>
	static inline mgl_f32_t mgl_f32_distance_3d(mgl_f32_t x0, mgl_f32_t y0, mgl_f32_t z0, mgl_f32_t x1, mgl_f32_t y1, mgl_f32_t z1)
	{
	...
	static inline mgl_f32_t mgl_f32_log(mgl_f32_t x)
	{
		return logf(x);
	}
	...
	static inline mgl_f32_t mgl_f32_log2(mgl_f32_t x)
	{
		return log2f(x);
	}
	...
	static inline mgl_f32_t mgl_f32_log10(mgl_f32_t x)
	{
		return log10f(x);
	}
	...
	static inline mgl_f32_t mgl_f32_exp(mgl_f32_t x)
	{
		return expf(x);
	}
	...
	/// <param name="x">Value</param>
	/// <returns>Value base 2 logarithm</returns>
	static inline mgl_f32_t mgl_f32_exp2(mgl_f32_t x)
	{
		return exp2f(x);
	}
